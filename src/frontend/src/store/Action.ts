...
import { convertToLineItem } from "../utils/Cart";
...
export const ACTIONS = {
    ...
    UPDATE_LINE_ITEM_IMAGES: "UPDATE_LINE_ITEM_IMAGES"
}
...
export const updateShippingMethod = (shippingMethodId: string, cart: Cart) => {
    const newCart = _.cloneDeep(cart) as Cart;
    newCart.shipments[0].shippingMethodId = shippingMethodId;
    return { type: "UPDATE_CART", payload: newCart};
}