                                ...
                                <div className="flex h-full flex-col bg-white shadow-xl">
                                    ...
                                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                        ...
                                        <div className="mt-6 flex justify-center gap-2">
                                            <button onClick={() => redirect("/checkout")} className="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 w-1/2 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Checkout</button>
                                            <button onClick={() => redirect("/cart-detail")} className="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 w-1/2 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">View Detail</button>
                                        </div>
