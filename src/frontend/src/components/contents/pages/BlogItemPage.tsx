...
const BlogItemPage: React.FC<BlogItem> = (props) => {
    return (
        <>
            <section
                    ...
                    <div className="grid grid-cols-1 pb-8 text-center mt-10">
                        ...
                        <ul className="list-none mt-6">
                            <li className="inline-block font-semibold text-white/50 mx-5">
                                ...
                                <span className="block">{moment(props.startPublish).format("ll")}</span>
                            </li>
                            <li className="inline-block font-semibold text-white/50 mx-5">
                                {" "}
                                <span className="text-white block">Time :</span>{" "}
                                <span className="block">{props.minsToRead ?? 0} Min Read</span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                        <div className="lg:col-span-8 md:col-span-6">
                            <div className="p-6 rounded-md shadow dark:shadow-gray-800">
                                ...
                                <div
                                    className="no-tailwindcss-base mt-6"
