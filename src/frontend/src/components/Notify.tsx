...
const Notify: FC<any> = () => {
    ...
    return(
        <>
            ...
            {!!notify.success && <div className="absolute top-2 right-2 z-999 flex items-center w-full max-w-xs p-4 mb-4 bg-white rounded-lg drop-shadow-2xl dark:text-gray-400 dark:bg-gray-800" role="alert">
                ...
                <div className="ml-3 text-base font-normal">{notify.success}</div>
            ...
            {!!notify.error && <div className="absolute top-2 right-2 z-999 flex items-center w-full max-w-xs p-4 mb-4 bg-white rounded-lg drop-shadow-2xl dark:text-gray-400 dark:bg-gray-800" role="alert">
                ...
                <div className="!text-red-700 ml-3 text-base font-normal">{notify.error}</div>
